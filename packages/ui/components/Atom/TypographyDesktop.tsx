...
export function TypographyDesktop() {
  return (
    <div className="min-h-screen bg-black p-8 md:p-12 lg:p-16">
      <div className="mx-auto max-w-7xl space-y-[200px] text-white">
        <h1 className="text-dh1 font-regular font-teodor text-white">
          Typography <span className="italic text-[#CCFF00]">Desktop</span>
        </h1>
        <div className="font-teodor grid grid-cols-2 gap-8 font-regular">
          <div className="space-y-[80px]">
            <h1 className="text-dd1">Display 1</h1>
            <h1 className="text-dd2">Display 2</h1>
            <h1 className="text-dd3">Display 3</h1>
            <h1 className="text-dd4">Display 4</h1>
          </div>
        ...
        <div className="grid grid-cols-2 gap-8">
          <div className="space-y-[80px] font-semibold">
            <h1 className="text-dh1">Heading 1</h1>
            <h2 className="text-dh2">Heading 2</h2>
            <h3 className="text-dh3">Heading 3</h3>
            <h4 className="text-dh4">Heading 4</h4>
            <h5 className="text-dh5">Heading 5</h5>
            <h6 className="text-dh6">Heading 6</h6>
          </div>
