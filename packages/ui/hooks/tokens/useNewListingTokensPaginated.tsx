...
import fetchNewListingTokens from '../../queries/Tokens/NewListing';
import type { Token } from '../../queries/Tokens/AllTokens';

export const useNewListingTokensPaginated = (network: string, limit: number, page: number) => {
  ...
  const fetchTokens = async () => {
    try {
      const tokens: Token[] = await fetchNewListingTokens(apiUrl, limit, page);
      return tokens;
    } catch (error) {
